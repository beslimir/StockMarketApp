...
fun StockChart(
    ...
    val upperValue = remember(info) { //remember value is calculated again when info changes
    ...
    Canvas(modifier = modifier) {
        ...
        val strokePath = Path().apply {
            ...
            for (i in info.indices) {
                ...
                val leftRatio = (getInfo.close - lowerValue) / (upperValue - lowerValue)
